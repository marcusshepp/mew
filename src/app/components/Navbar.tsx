...
export default function Navbar() {
    ...
    // If menu is open, render the mobile menu instead of the regular navbar
    if (isMenuOpen) {
        return (
            <div className="fixed inset-0 bg-black z-50 min-h-screen w-full">
                <div className="flex flex-col h-full">
                    ...
                    {/* Menu content */}
                    <div className="flex-1 flex flex-col items-center justify-start py-10 overflow-y-auto">
                        <ul className="flex flex-col items-center space-y-8 w-full mb-12">
                        ...
                        {/* Contact details */}
                        <div className="text-center px-6 mt-4 border-t border-blue-900/30 pt-6 w-4/5">
                            <a
    ...
    // Regular navbar when menu is closed
    return (
        <nav
